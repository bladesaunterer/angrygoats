...
public class AIPath : MonoBehaviour
{
    ...
    // IMPORTANT: Dean changed the name of this method from Update to FixedUpdate
    public virtual void FixedUpdate()
    {
        ...
        {
            // IMPORTANT: Dean changed this from add force to move position
            //rigid.AddForce(dir);
            rigid.MovePosition(dir * Time.deltaTime);
        }
        else
        {
